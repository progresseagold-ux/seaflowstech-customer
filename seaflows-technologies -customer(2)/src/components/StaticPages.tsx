          ...
          <div className="lg:col-span-5 flex flex-col gap-5 justify-between bg-gradient-to-br from-[#0c182f] to-[#040e1b] p-6 rounded-xl border border-gray-850 text-left">
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-4 text-xs">
                ...
                <div className="flex items-center gap-3.5">
                  <Phone size={18} className="text-[#FDB813] shrink-0" />
                  <div>
                    <span className="font-bold text-white block">Central Phone Line</span>
                    <span className="text-gray-400">+234 814 555 1234 (WhatsApp Direct active)</span>
                  </div>
                </div>
